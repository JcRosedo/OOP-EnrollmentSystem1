...
public class Registrar {
    ...
    public boolean updateStudent(Student student){
        ...
        if (success) {
            ...
            System.out.println("Student ID " + student.getPersonID() + " not found!");
        }
        return success;
    }
    ...
    public void calculateAndSetTuition(Student s, int units) {
        ...
        System.out.println("New fees added: PHP " + fee);
        System.out.println("Updated balance: PHP " + (currentBalance + fee));
    }
    ...
    public void processStudentPayment(String studentID, double amount){
        ...
        if (student != null) {
            ...
            System.out.println("ERROR: Payment failed: Student not found.");
        }
    }
    ...
    public void checkStudentBalance(String studentID) {
        ...
        if (student != null) {
            ...
            String status = tuitionReg.isFullyPaid(student) ? "CLEARED" : "PENDING";
    ...
    public void displaySectionDetails(String sectionName) {
        ...
        if (sec != null) {
            ...
            System.out.println("Section is not recognized.");
        }
    }
    ...
    public void displayHierarchy() {
        ...
        if (allDepts.isEmpty()) {
            System.out.println("No Departments are found. Please create first.");
            return;
        }
